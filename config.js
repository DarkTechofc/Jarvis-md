...
module.exports = {
  ...
  SESSION_ID: process.env.SESSION_ID || 'Jarvis_8266_8d65_6131_7031_5d4b_4a09_3106_ad3d',
  ...
  STICKER_PACKNAME: process.env.STICKER_PACKNAME || '乡Ｄ𝙽 ⃐🎋⃑ 𝙊𝘍𝘊 🎎🎭〴',
  ...
  SUDO: process.env.SUDO || '94764984597',
